...
/*2*/ DROP TABLE IF EXISTS silver.crm_prd_info;
...
/*3*/ DROP TABLE IF EXISTS silver.crm_sales_details;
...
/*4*/ DROP TABLE IF EXISTS silver.erp_cust_az12;
...
;
 /*5*/ DROP TABLE IF EXISTS  silver.erp_loc_a101;
CREATE TABLE silver.erp_loc_a101(
 ...
 /*6*/ DROP TABLE IF EXISTS  silver.erp_px_cat_g1v2;
